...
class Config:
    ...
    MIN_CONFIDENCE = 0.70  # 70% minimum model confidence
    ...
    # Data Collection
    LOOKBACK_BARS = 50000  # 8000 bars for stable statistics (was 10k - too slow)
    ...
    BARRIER_UPPER = 0.0015  # 0.15% profit target (realistic for 15min)
    BARRIER_LOWER = -0.0008  # 0.08% stop loss (tight but fair)
    BARRIER_TIME = 10  # Exit after 10 bars if neither hit
    ...
    AVOID_ASIAN_SESSION = False  # Skip 0-7 UTC (low liquidity)   normalmente true
    ...
    MAX_SPREAD_POINTS = 5  # Maximum 5 points ($0.05) spread
